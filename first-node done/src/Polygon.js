//you must use strict for classes. This is required to enforce class guidelines
"use strict"; 
...
//If there is more you have to export besides the class, then there are other ways to export.
